...
while n~=6   
 %%Menuaren barruan ez dagoen atal bat aukeratzen badu aukera ezegokia dela esango diogu eta badagoen atal bat aukeratzen badu bertako ariketa exekutatuko da.
 %%Edozein ariketa(6a izan ezik) egin ondoren edo existitzen ez den aukera bat eskatzen badu edozein tekla sakatzeko esango diogu menura bueltatzeko.
if 1>n || n>6;
...
n=input('Hautatu nahi duzun atalaren zenbakia:');
 ...
 %%6. atala aukeratzen badu, ariketa exekutatu ondoren menua itxiko da hurrengo mezua agertu ondoren 
